...
from switchboard.switchboard import FramelessQLineEdit
from switchboard.switchboard import DeviceListWidget
from switchboard.switchboard import ControlQPushButton

import resources_rc

class Ui_switchboard_window(object):
    def setupUi(self, switchboard_window):
        if not switchboard_window.objectName():
            switchboard_window.setObjectName(u"switchboard_window")
        switchboard_window.resize(1192, 952)
        switchboard_window.setMinimumSize(QSize(900, 500))
        icon = QIcon()
        icon.addFile(u":/icons/images/switchboard.png", QSize(), QIcon.Normal, QIcon.Off)
        switchboard_window.setWindowIcon(icon)
        self.menu_p4_refresh_cl = QAction(switchboard_window)
        self.menu_p4_refresh_cl.setObjectName(u"menu_p4_refresh_cl")
        self.actionMinimal_Sync = QAction(switchboard_window)
        self.actionMinimal_Sync.setObjectName(u"actionMinimal_Sync")
        self.update_settings = QAction(switchboard_window)
        self.update_settings.setObjectName(u"update_settings")
        self.actionAsd = QAction(switchboard_window)
        self.actionAsd.setObjectName(u"actionAsd")
        self.menu_new_config = QAction(switchboard_window)
        self.menu_new_config.setObjectName(u"menu_new_config")
        self.menu_delete_config = QAction(switchboard_window)
        self.menu_delete_config.setObjectName(u"menu_delete_config")
        self.actionTest = QAction(switchboard_window)
        self.actionTest.setObjectName(u"actionTest")
        self.centralwidget = QWidget(switchboard_window)
        ...
        self.sequence_line_edit.setProperty("recording", True)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/images/record_stop.png", QSize(), QIcon.Normal, QIcon.On)
        self.record_button.setIcon(icon1)
        self.record_button.setIconSize(QSize(60, 60))
        self.record_button.setCheckable(True)
        self.record_button.setChecked(False)
        self.record_button.setProperty("no_background", True)
        self.record_button.setProperty("no_border", True)
        ...
        self.level_combo_box = QComboBox(self.device_widget)
        self.level_combo_box.addItem("")
        self.level_combo_box.setObjectName(u"level_combo_box")
        sizePolicy3.setHeightForWidth(self.level_combo_box.sizePolicy().hasHeightForWidth())
        self.level_combo_box.setSizePolicy(sizePolicy3)
        self.level_combo_box.setMinimumSize(QSize(120, 0))
        self.level_combo_box.setMaximumSize(QSize(16777215, 16777215))

        self.horizontalLayout_7.addWidget(self.level_combo_box)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/images/icon_refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u":/icons/images/icon_refresh_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        icon2.addFile(u":/icons/images/icon_refresh_hover.png", QSize(), QIcon.Active, QIcon.Off)
        self.refresh_engine_cl_button.setIcon(icon2)
        self.refresh_engine_cl_button.setIconSize(QSize(18, 18))
        self.refresh_engine_cl_button.setProperty("frameless", True)
        ...
        self.refresh_project_cl_button.setIcon(icon2)
        self.refresh_project_cl_button.setIconSize(QSize(18, 18))
        self.refresh_project_cl_button.setProperty("frameless", True)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/images/icon_sync.png", QSize(), QIcon.Normal, QIcon.On)
        icon3.addFile(u":/icons/images/icon_sync_disabled.png", QSize(), QIcon.Disabled, QIcon.On)
        icon3.addFile(u":/icons/images/icon_sync_hover.png", QSize(), QIcon.Active, QIcon.On)
        self.sync_all_button.setIcon(icon3)
        self.sync_all_button.setIconSize(QSize(21, 21))
        self.sync_all_button.setProperty("frameless", True)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/icon_build.png", QSize(), QIcon.Normal, QIcon.On)
        icon4.addFile(u":/icons/images/icon_build_hover.png", QSize(), QIcon.Active, QIcon.On)
        self.build_all_button.setIcon(icon4)
        self.build_all_button.setIconSize(QSize(21, 21))
        self.build_all_button.setProperty("frameless", True)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/images/icon_sync_and_build.png", QSize(), QIcon.Normal, QIcon.On)
        icon5.addFile(u":/icons/images/icon_sync_and_build_disabled.png", QSize(), QIcon.Disabled, QIcon.On)
        icon5.addFile(u":/icons/images/icon_sync_and_build_hover.png", QSize(), QIcon.Active, QIcon.On)
        self.sync_and_build_all_button.setIcon(icon5)
        self.sync_and_build_all_button.setIconSize(QSize(21, 21))
        self.sync_and_build_all_button.setProperty("frameless", True)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/images/icon_open.png", QSize(), QIcon.Normal, QIcon.Off)
        icon6.addFile(u":/icons/images/icon_close.png", QSize(), QIcon.Normal, QIcon.On)
        icon6.addFile(u":/icons/images/icon_open_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        icon6.addFile(u":/icons/images/icon_open_hover.png", QSize(), QIcon.Active, QIcon.Off)
        icon6.addFile(u":/icons/images/icon_close_hover.png", QSize(), QIcon.Active, QIcon.On)
        self.launch_all_button.setIcon(icon6)
        self.launch_all_button.setIconSize(QSize(21, 21))
        self.launch_all_button.setCheckable(True)
        self.launch_all_button.setProperty("frameless", True)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/images/icon_connect.png", QSize(), QIcon.Normal, QIcon.Off)
        icon7.addFile(u":/icons/images/icon_connected.png", QSize(), QIcon.Normal, QIcon.On)
        icon7.addFile(u":/icons/images/icon_connect_hover.png", QSize(), QIcon.Active, QIcon.Off)
        icon7.addFile(u":/icons/images/icon_connected_hover.png", QSize(), QIcon.Active, QIcon.On)
        self.connect_all_button.setIcon(icon7)
        self.connect_all_button.setIconSize(QSize(21, 21))
        self.connect_all_button.setCheckable(True)
        self.connect_all_button.setProperty("frameless", True)
        ...
        self.multiuser_session_lineEdit.setProperty("recording", True)

        self.horizontalLayout_2.addWidget(self.multiuser_session_lineEdit)
        ...
        self.verticalLayout_4.addWidget(self.logger_level_comboBox)
        ...
        brush3 = QBrush(QColor(177, 177, 177, 128))
        ...
        brush5 = QBrush(QColor(177, 177, 177, 128))
        ...
        brush7 = QBrush(QColor(50, 50, 50, 255))
        ...
        brush9 = QBrush(QColor(177, 177, 177, 128))
        ...
        font8 = QFont()
        font8.setFamily(u"DroidSansMono")
        ...
        switchboard_window.setCentralWidget(self.centralwidget)
        self.line.raise_()
        self.statusbar = QStatusBar(switchboard_window)
        self.statusbar.setObjectName(u"statusbar")
        switchboard_window.setStatusBar(self.statusbar)
        self.menu_bar = QMenuBar(switchboard_window)
        ...
        switchboard_window.setMenuBar(self.menu_bar)
        ...
        self.retranslateUi(switchboard_window)

        self.tabs_main.setCurrentIndex(-1)
        self.logger_level_comboBox.setCurrentIndex(2)


        QMetaObject.connectSlotsByName(switchboard_window)
    # setupUi
    ...
    def retranslateUi(self, switchboard_window):
        ...
        self.level_combo_box.setItemText(0, QCoreApplication.translate("switchboard_window", u"DIJ_Flare_P", None))

        self.level_combo_box.setCurrentText(QCoreApplication.translate("switchboard_window", u"DIJ_Flare_P", None))
        ...
        self.label.setText(QCoreApplication.translate("switchboard_window", u"Multiuser Session", None))
